<template>
  <div id="callaxois">
    <nav class="navbar navbar-expand-lg navbar-light bg-bb pdd-z">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mar-left">
          <li class="nav-item">
            <router-link class="nav-link" to="/">หน้าหลัก
    ...
    <div class="content-all text-left-al">
      <div class="h1-head-cus">
        <h1>หนังสืออิเล็กทรอนิกส์ (Electronic book)</h1>
      </div>
      <div class="container">
      <div class="row">
         <div class="col-md-4 tag-a-color">
             <a :href="linkEbook" target="_blank" title="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin">
             <div class="card-ebook">
                 <img v-bind:src="imageLink2" alt="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin"/>
                 <h4>หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin</h4>
             </div>
             </a>
         </div>
         <div class="col-md-4 tag-a-color">
             <a v-bind:href="linkEbook" target="_blank" title="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin">
             <div class="card-ebook">
                 <img v-bind:src="imageLink2" alt="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin"/>
                 <h4>หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin</h4>
             </div>
