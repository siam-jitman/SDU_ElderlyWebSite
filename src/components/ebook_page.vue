          ...
          <div class="row">
            <div class="col-md-4 tag-a-color">
              <a
                :href="linkEbook"
                target="_blank"
                title="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin"
              >
                <div class="card-ebook">
                  <img
                    v-bind:src="imageLink2"
                    alt="หลักของการถ่ายภาพที่ดีทั่วไป โดย Sornsak Sakbodin"
                  />
